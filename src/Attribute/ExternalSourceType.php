...
namespace Drupal\external_content\Attribute;

use Drupal\Component\Plugin\Attribute\AttributeBase;
use Drupal\Core\StringTranslation\TranslatableMarkup;

/**
 * The external_source_type attribute.
 */
#[\Attribute(\Attribute::TARGET_CLASS)]
final class ExternalSourceType extends AttributeBase {

  /**
   * Constructs a new ExternalSourceType instance.
   *
   * @param string $id
